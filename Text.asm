	...
	;|| File Name: Text											||
	;|| File Description:										||
	;||		a sub file thats defines everything related to text:||
	;||		procedures that prints char, string and numbers to	||
	;||		the screen, new line creator, change the position of||
